...
exports.attachMiddleWares = exports.app = void 0;
// @ts-nocheck
...
tsyringe_1.container.register(express, { useValue: exports.app });
class BaseAppContainer {
    ...
    constructor(options) {
        ...
        if (middleware) { // 데코레이터 미들웨어 등록
            ...
            middlewareArr.forEach(func => exports.app.use(func));
        }
        // 파라미터 미들웨어 등록
        (_a = options === null || options === void 0 ? void 0 : options.initMiddleWares) === null || _a === void 0 ? void 0 : _a.forEach(func => exports.app.use(func));
        // 템플릿 및 에셋 디렉토리 등록
        BaseAppContainer.templateAndAssets(dirname);
        // 기본 미들웨어 등록
        // 에셋보다 먼저 등록시 헤더가 붙지 않는 문제가 발생함
        attachMiddleWares(exports.app);
        // !반드시 미들웨어 등록 후 실행!
    ...
    static templateAndAssets(dirname) {
        ...
        exports.app.use('/static', express.static(path.join(dirname, '../resources/static'), {
            cacheControl: true,
            maxAge: 3600 * 1000,
            etag: false
        }));
        ...
        ['favicon.ico', 'robots.txt'].forEach(filename => {
            exports.app.get(`/${filename}`, (req, res) => res.sendFile(ResourceLoader_1.ResourcePath(`/static/${filename}`)));
        });
        // 템플릿 폴더 및 엔진 설정
        exports.app.set('views', path.join(dirname, '../resources/templates/'));
        exports.app.set('view engine', 'ejs');
        exports.app.engine('html', ejs.renderFile);
    }
}
 ...
 * 기본 미들웨어 등록
 */
function attachMiddleWares(app = app) {
    // cookie parser
